...
function Content(props) {
    ...
    return (
        ...
        <div className="artist is-verified" Style="height: 100%;">
            <div className="artist__header"  style={{ backgroundImage: `url(${artist.picture_xl})`}}>
                ...
                <div className="artist__listeners">
                    <div className="artist__listeners__count">{artist.nb_fan}</div>
